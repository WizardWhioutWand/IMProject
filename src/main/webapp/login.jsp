...
<head>
    ...
    <link href="${pageContext.request.contextPath}/themes/rongzi/css/qq.css" rel="stylesheet" type="text/css" />
    ...
    <link href="${pageContext.request.contextPath}/themes/rongzi/css/usergetpwd.css" rel="stylesheet" type="text/css" />
    <script src="${pageContext.request.contextPath}/themes/rongzi/js/yu.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/themes/rongzi/js/user.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/themes/rongzi/js/tb.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/themes/rongzi/js/jquery.js" type="text/javascript"></script>
    ...
    <link href="${pageContext.request.contextPath}/themes/rongzi/css/new.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/themes/rongzi/css/userreg.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/themes/rongzi/css/userlogin.css" rel="stylesheet" type="text/css" />
...
<div style="position: absolute;font-size:12px;margin-top: 55px;margin-left: 170px;">战　略　合　作　伙　伴</div>-->
    ...
    <div class="bodyer clearfix">
        <div class="login-left"><img src="${pageContext.request.contextPath}/themes/rongzi/longbao/images/login_03.jpg" width="496" height="320" /></div>

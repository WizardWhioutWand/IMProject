...
<head>
    ...
    <link rel="stylesheet" href="themes/rongzi/longbao/style.css" type="text/css" media="screen, projection" />
    <link rel="shortcut icon" type="image/x-icon" href="syico.ico" />
    <script src='/themes/rongzi/longbao/js/jquery-1.4.2.min.js' type="text/javascript"></script>
    <script src="/themes/rongzi/js/sub.js" type="text/javascript"></script>
    <script src="/themes/rongzi/js/yu.js" type="text/javascript"></script>
    <script src="/themes/rongzi/js/tb.js" type="text/javascript"></script>
    <script src="/themes/rongzi/js/tipswindown.js" type="text/javascript"></script>
    <script src="/themes/rongzi/js/lhgdialog.min.js" type="text/javascript"></script>
    <script src="plugins/timepicker/WdatePicker.js" type="text/javascript"></script>
    <script src="/themes/rongzi/js/base.js" type="text/javascript"></script>
    <script type="text/javascript" src="/themes/rongzi/longbao/js/scrollNews.js"></script>
</head>
...
<div class="bodyer clearfix">
    ...
    <div class="statistics"><span><img src="themes/rongzi/longbao/images/Statistics.jpg" width="16" height="15" /> 网站数据统计:</span><span>放款总额：<em>14,500</em>元</span><span>投资已赚取收益：<em>6</em>元</span></div>

    <div>
        <ul>
            <a href="how_it_works/index.html">
                <li style="float:left;width:245px">
                    <img src="themes/rongzi/longbao/images/abv1.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
            ...
            <a href="invest/index.html">
                <li style="float:left;width:245px">
                    <img src="themes/rongzi/longbao/images/abv2.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
            ...
            <a href="hetong/index.html">
                <li style="float:left;width:245px">
                    <img src="themes/rongzi/longbao/images/abv3.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
            ...
            <a href="">
                <li style="float:left;width:245px">
                    <img src="themes/rongzi/longbao/images/abv4.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
            ...
            <a href="gsjj/index.html">
                <li style="float:left;width:245px">
                    <img src="themes/rongzi/longbao/images/abv5.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
            ...
            <a href="fxgk/index.html">
                <li style="float:left;width:245px">
                    <img src="themes/rongzi/longbao/images/abv6.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
            ...
            <a href="gsjj/index.html">
                <li style="float:left;width:245px">
                    <img src="themes/rongzi/longbao/images/abv7.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
            ...
            <li style="float:left;width:245px">
                <img src="themes/rongzi/longbao/images/abv8.jpg" style="width:64px;height:64px;margin:10px;float:left;"></img>
    ...
    <dl class="index-title">
        <dt class="index-titleBg"><img src="themes/rongzi/longbao/images/icon_invest.png" align="absmiddle" width="20" height="25"> 所 有 项 目</dt>
        <dd>
                    ...
                    <tr>
                        ...
                        <td rowspan="2">
                            ...
                            <a href="./invest/full_success/a20171115707.html">
                                <img src="./themes/rongzi/images/list_091.jpg" width="78" height="33">
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td width="200">信用等级：<img src="./data/images/credit/credit_hr.gif" title="14分"></td>
    ...
    <div class="bottom">
        <dl class="box980 bottomNav">
            <dt><span><a href="#"><img src="themes/rongzi/longbao/images/icon_top.jpg" width="18" height="18" /> 返回顶部</a></span><a href="gsjj/index.html">关于我们</a>
                ...
                <a href="admin/login.jsp" target="_blank">后台管理</a></dt>
            <dd>
